...
const DecentralizedIcon = ({ active }: DecentralizedIconProps) => {
    ...
    return (
        <svg
            ...
            className="w-full h-full transform transition-all ease-in-out duration-200"
        >
            <g clipPath="url(#clip0_2508_182)">
                <path
                    ...
                    stroke="url(#paint0_linear_2508_182)"
                    strokeDasharray="8 8"
                />
                <path
                ...
                <path
                    ...
                    className={`${transitionClasses} ${
                        active ? 'fill-[#13171D]' : 'fill-white opacity-10'
                    }`}
                />
                <g clipPath="url(#clip1_2508_182)">
                    <g clipPath="url(#clip2_2508_182)">
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
            ...
            <defs>
                ...
                <clipPath id="clip0_2508_182">
                    <rect width="100" height="114" fill="white" />
                </clipPath>
                <clipPath id="clip1_2508_182">
                    <rect
                        width="26"
                        height="26"
                        fill="white"
